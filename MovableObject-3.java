...
public abstract class MovableObject extends GameObject implements IDrawable{
    ...
    private ArrayList<Image> spritesBlade;
    ...
    public void move(int GAME_TICK, int height, int width) {
        ...
        if(newLocation.getXCoordinate() < 0)
        {
            ...
            //System.out.println("newLocation.getXCoordinate " +newLocation
            // .getXCoordinate());
        ...
        if(newLocation.getYCoordinate() < 250)
        {
            ...
            //System.out.println("newLocation.getYCoordinate() " +
            // newLocation.getYCoordinate());
        ...
        if(newLocation.getYCoordinate() > (height+230) ){
            ...
            //System.out.println("newLocation.getYCoordinate "+ newLocation
            // .getYCoordinate() );
    ...
    public void draw(Graphics g) {
        ...
        try {
            ...
            g.drawImage(currImage.rotate(getHeading() - 90), xVal, yVal, size,
                    size);
            if (this instanceof PlayerHelicopter || this instanceof NonPlayerHelicopter) {
